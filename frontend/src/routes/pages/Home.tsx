...
export default function Home() {
  ...
  return (
    <>
      <section className="px-4 md:px-5 lg:px-6 py-10 bg-(--black)">
        <div className="flex flex-col lg:flex-row gap-10 w-full max-w-480 mx-auto">
      ...
      <section className="bg-(--white) py-5">
        <div className="w-full max-w-480 mx-auto flex gap-2.5 items-center px-4 md:px-5 lg:px-6 pb-5">
